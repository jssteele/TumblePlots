...
mdscope=new.env(parent=emptyenv())
mdscope$predicted_values = c(llhr,hlhr,lhhr,hhhr)
# ABSTRACT OUT
...
prep2 = cbind(newdat$tarpred, newdatout)
plot(NA, xlim=range(prep[,1]),ylim=range(prep[,2]), ann=FALSE)
#plot(prep[,1],prep[,2],ann=FALSE, ylim=c(20,65),xlim=c(5,22))
lines(prep[3:4,1],prep[3:4,2], type='o')
lines(prep[1:2,1],prep[1:2,2], type='o', lty=2)
